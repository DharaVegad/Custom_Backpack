<%@ Page Title="" Language="C#" MasterPageFile="~/admin project/Master_ad_home.master" AutoEventWireup="true" CodeFile="user_content.aspx.cs" Inherits="admin_project_user_content" %>
                ...
                <table class="auto-style2">
                    ...
                    <tr>
                        <td class="auto-style4">
                            <asp:Label ID="Label1" runat="server" BackColor="#003300" BorderStyle="Solid" Font-Size="Large" ForeColor="White" Height="25px" Text='<%# Eval("name") %>' Width="131px"></asp:Label>
                        </td>
                    </tr>
                    <tr>
